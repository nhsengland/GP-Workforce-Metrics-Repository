...
if "%JEMMA%" == "" (
  ...
  set transformsGradleDistributionUrl=!ORG_GRADLE_PROJECT_artifactsUri!/repositories/ri.gradle.distributions.artifacts.repository/contents/release/files/gradle-7.2-bin.zip
)
